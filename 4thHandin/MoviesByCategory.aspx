...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MovieDBListConnectionStringAndreas %>" SelectCommand="SELECT DISTINCT [Genre] FROM [MovieDBList]"></asp:SqlDataSource>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:MovieDBListConnectionStringAndreas %>" SelectCommand="SELECT * FROM [MovieDBList] WHERE ([Genre] = @Genre)">
                <SelectParameters>
